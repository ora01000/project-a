...
from backend.app.api.runtime_internal import router as runtime_internal_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(runtime_internal_router, prefix="/api")
    return app
