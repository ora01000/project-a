  ...
  return (
    ...
    >
      ...
      {agent.operation_status === "working" && agent.operation_detail ? (
        <div className="flex min-h-0 flex-1 items-center px-3 py-2">
          <span
            className="truncate rounded border border-emerald-800/60 bg-emerald-950/40 px-2 py-1 text-[11px] text-emerald-200"
